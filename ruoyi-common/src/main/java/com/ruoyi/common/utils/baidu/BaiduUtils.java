...
public class BaiduUtils {
    ...
    private static final String appKey = "HOTNM8yInQYICDTcwmPyUeWu";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
    private static final String secretKey = "vs2gXbgbOShQ60qfASbHfzA5gkNj9ysq";
    ...
    private static final String filePtah = "";
    private static String cuid = "1234567JAVA";

    public static String tts(String text) throws DemoException, IOException {
        return  run(text) ;
    }

    private static String run(String text) throws IOException, DemoException {
        ...
        if (contentType.contains("audio/")) {
            ...
            String audioPath=filePtah+filename;
